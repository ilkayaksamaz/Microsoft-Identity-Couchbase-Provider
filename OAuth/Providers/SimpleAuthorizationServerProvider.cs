...
using INGA.Framework.EnterpriseLibraries.Authentication.OAuth.Repositories;
...
namespace INGA.Framework.EnterpriseLibraries.Authentication.OAuth.Providers
{
    public class SimpleAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        public override Task ValidateClientAuthentication(OAuthValidateClientAuthenticationContext context)
        {
            ...
            using (OAuthRepository _repo = new OAuthRepository())
            {
        ...
        public async override Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var userManager = new UserManager<UserModel>(new UserStore<UserModel>());
            ...
            {
                context.SetError("email_confirmation_required", "Please confirm your email");
                return;
            }
